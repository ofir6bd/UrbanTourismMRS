...
from collaborative_filtering import _knn_baseline, _knn_baseline_search_space, _knn_baseline_search_space_tied_constraints
from collaborative_filtering import _hybrid_knn, _hybrid_knn_search_space,_hybrid_knn_search_space_tied_constraints
from collaborative_filtering import _hybrid_knn_25, _hybrid_knn_25_search_space,_hybrid_knn_25_search_space_tied_constraints
from collaborative_filtering import _hybrid_knn_75, _hybrid_knn_75_search_space,_hybrid_knn_75_search_space_tied_constraints
...
CF_map = {
    ...
    # "ngcf": _ngcf,
    "ease": _ease,
    "knn_baseline": _knn_baseline,  
    "hybrid_knn": _hybrid_knn,
    "hybrid_knn25": _hybrid_knn_25,  
    "hybrid_knn75": _hybrid_knn_75, 
}
CF_search_space_map = {
    ...
    "knn_baseline": (_knn_baseline_search_space, _knn_baseline_search_space_tied_constraints),
    "hybrid_knn": (_hybrid_knn_search_space, _hybrid_knn_search_space_tied_constraints),
     "hybrid_knn25": (_hybrid_knn_25_search_space, _hybrid_knn_25_search_space_tied_constraints),  
    "hybrid_knn75": (_hybrid_knn_75_search_space, _hybrid_knn_75_search_space_tied_constraints),  
}
